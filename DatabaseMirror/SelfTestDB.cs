...
namespace DDB
{
    ...
    public class SelfTestList
    {
        ...
        static public void Init()
        {
            ...
            list.Add(new SelfTestDB("Self Test 1", 101, "ST_101", 
                                    new List<VariableDB>() { SelfTestVariableList.GetObject(25), SelfTestVariableList.GetObject(26) },
            ...
            list.Add(new SelfTestDB("Self Test 2", 102, "ST_102",
                                    new List<VariableDB>() { SelfTestVariableList.GetObject(27) },
    ...
    public class SelfTestDB: iDDBHelpObject
    {
        ...
        public SelfTestDB(String n, Int32 num, String c, List<VariableDB> vList, List<SelfTestMessageDB> mList, SelfTestMessageDB d)
        {
            name = n;
            number = num;
            embeddedName = c;
