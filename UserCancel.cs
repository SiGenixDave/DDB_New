...
namespace DDB
{
    ...
    internal class UserCancel
    {
        ...
        {
            DialogResult dr = MessageBox.Show("Are you sure that you want to abort the changes that you made to the " + info + "?", "UserCancel Operation",
